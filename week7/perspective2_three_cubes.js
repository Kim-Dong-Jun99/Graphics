...
function colorCube() {
    ...
    // bottom
    quad(8 + 1, 8, 8 + 3, 8 + 2); // blue ( +z ), frontal
    quad(8 + 2, 8 + 3, 8 + 7, 8 + 6); // yellow ( +x ), right
    quad(8 + 3, 8, 8 + 4, 8 + 7); // green ( -y ), bottom
    //    quad( 8+6, 8+5, 8+1, 8+2 ); // cyan ( +y ), top
    quad(8 + 4, 8 + 5, 8 + 6, 8 + 7); // red ( -z ), back
    quad(8 + 5, 8 + 4, 8, 8 + 1); // magenta ( -x ) left

    quad(16 + 1, 16, 16 + 3, 16 + 2); // blue ( +z ), frontal
    quad(16 + 2, 16 + 3, 16 + 7, 16 + 6); // yellow ( +x ), right
    quad(16 + 3, 16, 16 + 4, 16 + 7); // green ( -y ), bottom
...
function quad(a, b, c, d) {
    ...
    let indices = [a, b, c, a, c, d]; // 1 0 3, 1 3 2 // 4 5 6, 4 6 7
